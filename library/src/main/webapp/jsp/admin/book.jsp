...
<title>하이디미어 도서관 - 관리자 페이지 : 도서관리</title>
	...
	<div class="adminContent">
		...
		<form id = "f" action="" method="post">
			<div class = "subMenu_book" id = "subMenu_info">
				<ul id = "info_menu">
					<li class = "info_menu active" value="bookLoan">대출</li>
					<li class = "info_menu" id="memberListMenu" value = "bookManage">반납</li>
					<li class = "info_menu" id="memberListMenu" value = "borrowList">조회</li>
				</ul>
			</div>
