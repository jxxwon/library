	...
	<div class="loginContent">
		...
		<div class="RIContainer">
			<form action="kakaoRegisterProc" method="post" id="f">
				<label for = "name" id="nameLabel">이름
					 <span class="caution">*</span>	
				</label>
				<input type="text" name="name" id="name" placeholder="이름" onchange="idCheck()"><br>
				<label>보호자 이름</label>
				...
				<span class="caution">*아이디는 6~12자리의 영문 또는 숫자 혼용, 특수문자 제외</span><br>
				
				<label>비밀번호
					<span class="caution">*</span>	
				</label>
				<input type="password" name="pw" placeholder="비밀번호" id="pw"><br>
				<span class="caution">*비밀번호는 10 ~ 12자리이며, 반드시 영문자, 숫자를 혼합하여
